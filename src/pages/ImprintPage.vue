...
const contacts: Contact[] = [
  {
    heading: '1. Vorstand und Geschäftsführer',
    name: 'Franz Ikker',
  ...
  {
    heading: 'Realisierung der Seite',
    name: 'Matthias Strolz',
    addressLines: ['Ludwig-Wilhelm-Straße 17', '76131 Karslruhe'],
...
const liabilitySections: LiabilitySection[] = [
  {
    heading: '1. Inhalt des Onlineangebotes:',
  ...
  {
    heading: '3. Urheber- und Kennzeichenrecht:',
