...
<template>
  <div class="bg-chalk flex min-h-screen flex-col font-sans">
    ...
    <main class="mx-auto w-full max-w-3xl flex-1 px-6 pt-28 pb-24 sm:px-8">
      ...
      <div class="border-club-blue/10 mt-8 rounded-2xl border bg-white p-6 shadow-sm">
        <div class="text-club-blue mb-3 text-xs font-bold tracking-[0.08em] uppercase">
          Nächste Termine
        </div>
        <div
          v-for="event in upcomingEvents"
          :key="event.label"
          class="text-pitch-dark mb-2 flex items-center gap-2.5 text-[15px] last:mb-0"
        >
          <svg
            width="18"
            height="18"
        ...
        <RouterLink
          to="/termine"
          class="text-club-blue mt-3 inline-block text-sm font-semibold underline"
        >
